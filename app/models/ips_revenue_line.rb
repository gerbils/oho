# == Schema Information
#
# Table name: raw_ips_revenue_lines
#
...
#  raw_ips_statement_detail_id :bigint           not null
#  sku_id                      :integer
#
# Indexes
#
#  index_raw_ips_revenue_lines_on_raw_ips_statement_detail_id  (raw_ips_statement_detail_id)
#
# Foreign Keys
#
#  fk_rails_...  (raw_ips_statement_detail_id => raw_ips_statement_details.id)
#
